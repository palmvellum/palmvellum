export default {
  ...
  'settings.palmEnrollHeading': 'Palm enrollment',
  'settings.palmEnrolled': 'A Palm is enrolled',
  'settings.tokenIssued': 'token issued',
  'settings.enrollAnotherHint': 'Need to enroll a second Palm or rotate the token? Click below — the previous token is invalidated immediately.',
  'settings.enrollInstructions': 'Generate a one-time HotSync token. Paste it into your Mac daemon .env as PALMVELLUM_HOTSYNC_TOKEN. The daemon trades it for your user_id on startup and uses it for every sync from your Palm.',
  'settings.tokenOnceWarning': 'shown once. copy it now.',
  'settings.copyClipboard': 'copy to clipboard',
  'settings.enrollPalm': 'enroll a Palm',
  'settings.reissueToken': 're-issue token',
